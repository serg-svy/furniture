(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-main__slider")) new core(".slider-main__slider", {
            ...
            navigation: {
                prevEl: ".main-slider__slider .slider-arrow_prev",
                nextEl: ".main-slider__slider .slider-arrow_next"
            },
            on: {}
        });
...
***************************************************************************** */
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (targetElement.classList.contains("search-form__icon")) targetElement.closest(".search-form").classList.toggle("_active"); else if (!targetElement.closest(".search-form") && document.querySelectorAll(".search-form._active").length > 0) script_removeClasses(document.querySelectorAll(".search-form._active"), "_active");
